...
--resource:known_variants /data/diagnostics/pipelines/AgilentHaloPlexEpilepsyPanel/"$Version"/AgilentHaloPlexEpilepsyPanel_KnownVariants.vcf \
...
/data/diagnostics/pipelines/AgilentHaloPlexEpilepsyPanel/"$Version"/AgilentHaloPlexEpilepsyPanel_PreferredTranscripts.txt
...
/data/diagnostics/pipelines/AgilentHaloPlexEpilepsyPanel/"$Version"/AgilentHaloPlexEpilepsyPanel_Gene_List.txt \
...
/usr/java/jdk1.7.0_51/bin/java -Djava.io.tmpdir=tmp -jar /data/diagnostics/apps/RegionAnnotator.jar "$SampleID"_gaps.bed "$RunID"_"$SampleID"_Gaps_VEP.txt /data/diagnostics/pipelines/AgilentHaloPlexEpilepsyPanel/"$Version"/AgilentHaloPlexEpilepsyPanel_PreferredTranscripts.txt
